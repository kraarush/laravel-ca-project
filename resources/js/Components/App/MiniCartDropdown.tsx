    ...
    return (
        ...
        <div tabIndex={0} role="button" className="btn btn-ghost btn-circle">
            <div className="indicator">
                ...
                <span className="badge badge-sm indicator-item">{totalQuantity || 0}</span>
            </div>
        </div>
        <div tabIndex={0} className="card card-compact dropdown-content bg-base-100 z-10 mt-3 w-[480px] shadow">
            <div className="card-body">
                <span className="text-lg font-bold">{totalQuantity || 0} Items</span>
                <div className="my-4 max-h-[300px] overflow-auto">
                    ...
                    {miniCartItems.map((item) => (
                        ...
                        <div key = {item.id} className={'flex gap-4 p-3'}>
                            <Link href={productRoute(item)} className={'w-16 h-16 flex justify-center'}>
